...
class PricingOverheadTests(TestCase):
    ...
    def test_overheads_are_added_to_sale_but_not_profit(self):
        ...
        self.assertEqual(q.pricing_snapshot["overhead_total_percent"], "12")
        self.assertEqual(q.pricing_snapshot["tax_percent"], "6")
        self.assertEqual(q.pricing_snapshot["topup_fee_percent"], "3")
        self.assertEqual(q.pricing_snapshot["other_expenses_percent"], "2")
        self.assertEqual(q.pricing_snapshot["refund_withdrawal_percent"], "1")
