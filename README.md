...
> **Единый план разработки:** `docs/SPRINT_PLAN.md`. Перед продолжением разработки человек или AI-агент должен сначала прочитать этот файл, найти единственный `IN PROGRESS` sprint и продолжать его, не создавая новую нумерацию и не повторяя уже закрытый scope.
