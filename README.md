...
Репозиторий создаётся по master-spec **AI Workspace FINAL v8**. Завершены Sprint 0–21.
...
Следующий этап: Sprint 22 — генерация изображений, галерея и история визуальных результатов.
