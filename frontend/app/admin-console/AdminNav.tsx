...
const links=[
["Обзор","/admin-console"],["Пользователи","/admin-console/users"],["Провайдеры и цены","/admin-console/providers"],["Финансы","/admin-console/finance"],["Платежи","/admin-console/payments"],["Безопасность","/admin-console/security"],["Поддержка","/admin-console/support"],["Операции","/admin-console/operations"],["Compliance","/admin-console/compliance"]
];
